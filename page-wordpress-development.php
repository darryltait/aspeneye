...
<div class="container">
        ...
        <h2 class="text-center display-2 mt-5 mb-4">Your business is unique. </h2>
        <h2 class="text-center display-2 mt-2 mb-4 fade-in2">Shouldn't your website be as well?</h2>
